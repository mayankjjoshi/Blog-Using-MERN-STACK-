...
const PostDetails = () => {
  ...
  const handleDeletePost=async ()=>{
    ...
    try{
      const res=await axios.delete("http://localhost:4000/api/posts/"+postId,{withCredentials:true})
      console.log(res.data)
      navigate("/")
  ...
  const postComment=async(e)=>{
    e.preventDefault()
    try{
      const res=await axios.post("http://localhost:4000/api/comments/create",
