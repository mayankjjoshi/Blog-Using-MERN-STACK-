...
const CreatePost = () => {
    ...
    const handleCreate=async (e)=>{
        ...
        if(file){
          ...
          //img upload
          try{
            const imgUpload=await axios.post("http://localhost:4000/api/upload",data)
        ...
        // console.log(post)
        try{
          const res=await axios.post("http://localhost:4000/api/posts/create",post,{withCredentials:true})
